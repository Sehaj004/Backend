...
namespace robot_controller_api.Persistence
{
    ...
    {
        private const string CONNECTION_STRING = "Host=localhost;Username=postgres;Password=2004;Database=sit331";

        // Method to fetch all robot maps
        public static List<Map> GetRobotMap()
        {
        ...
        public static List<Map> GetRobotMapSquare()
        {
            var newmap = new List<Map>();
        ...
        public static void PostMap(Map newmap)
        {
            using var conn = new NpgsqlConnection(CONNECTION_STRING);
            conn.Open();
        ...
        public static void UpdateMap(int id, Map newmap)
        {
            using var conn = new NpgsqlConnection(CONNECTION_STRING);
            conn.Open();
        ...
        public static bool IsMapIndexValid(int id, int x, int y)
        {
            int col = 0; 
            int row = 0;
